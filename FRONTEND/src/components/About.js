    ...
    <div className="bg">
              ...
              <div className="carousel-item active">
                ...
                <div className="container">
                  <div className="carousel-caption text-end">
                    ...
                    <p>
                      <Link className="btn btn-lg btn-info" to="/dogs">
                        Browse Happiness
                      </Link>
                    </p>
                  </div>
          ...
          <div className="container marketing">
            <div className="row" style={carouselCard}>
              <div className="col-lg-4 animate__animated animate__bounceInLeft animate__slower">
              ...
              <div className="col-lg-4 animate__animated animate__bounceInDown animate__slower">
                {/* <svg className="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#777"></rect><text x="50%" y="50%" fill="#777" dy=".3em">140x140</text></svg> */}
                <img
              ...
              <div className="col-lg-4 animate__animated animate__bounceInRight animate__slower">
                {/* <svg className="bd-placeholder-img rounded-circle" width="140" height="140" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 140x140" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#777"></rect><text x="50%" y="50%" fill="#777" dy=".3em">140x140</text></svg> */}
                <img
