    ...
    <div
      ...
      <section className="py-8 py-md-11 " style={{ padding: "50px" }}>
        <div className="container">
          <div className="row">
            <div
              className="col-12 col-md-4 aos-init aos-animate animate__animated animate__bounceInLeft animate__slower"
              data-aos="fade-up"
            >
              <div className="icon text-primary mb-3">
                <img
                  src="https://th.bing.com/th/id/OIP.eE8aHJYx5m4mGjhecXmwVQHaHa?pid=ImgDet&rs=1"
                  alt=""
                  height="70"
                  width="70"
                />
            ...
            <div
              className="col-12 col-md-4 aos-init aos-animate animate__animated animate__bounceInDown animate__slower"
              data-aos="fade-up"
              data-aos-delay="50"
            >
              <div className="icon text-primary mb-3">
            ...
            <div
              className="col-12 col-md-4 aos-init aos-animate animate__animated animate__bounceInRight animate__slower"
              data-aos="fade-up"
              data-aos-delay="100"
            >
              <div className="icon text-primary mb-3">
                <img
                  src="https://th.bing.com/th/id/OIP.3x8KY0h4VxYmOB7ndFhZRgHaHa?pid=ImgDet&rs=1"
                  alt=""
                  height="70"
                  width="70"
                />
      ...
      <div className="container">
        ...
        <div className="row featurette">
          <div className="col-md-7 animate__animated animate__slideInLeft  animate__slower">
          ...
          <div className="col-md-5 animate__animated animate__slideInRight  animate__slower">
        ...
        <div className="row featurette">
          <div className="col-md-7 order-md-2 animate__animated animate__slideInRight  animate__slower">
            <h2 className="featurette-heading">
          ...
          <div className="col-md-5 order-md-1 animate__animated animate__slideInLeft  animate__slower">
            {/* <svg className="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500" height="500" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: 500x500" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#eee"></rect><text x="50%" y="50%" fill="#aaa" dy=".3em">500x500</text></svg> */}
            <img
