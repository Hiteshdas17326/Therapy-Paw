  ...
  dogs = [
    {
        ...
        content:
            " ncludes a Pixel 6 or 6 Pro phone (with an upgrade in two years), an exte… [+1151 chars]",price:" 600"
    },
    {
        ...
        content:
            " ncludes a Pixel 6 or 6 Pro phone (with an upgrade in two years), an exte… [+1151 chars]",price:" 700"
    },
    {
  ...
  
    {
        ...
        content:
            " ncludes a Pixel 6 or 6 Pro phone (with an upgrade in two years), an exte… [+1151 chars]",price:" 650"
    },
    {
  ...
  
    {
        ...
        content:
            " ncludes a Pixel 6 or 6 Pro phone (with an upgrade in two years), an exte… [+1151 chars]",price:" 500"
    },
    {
        ...
        breed: "pug",
        content:
            " ncludes a Pixel 6 or 6 Pro phone (with an upgrade in two years), an exte… [+1151 chars]",price:" 550"
    },
    {
    ...
    },
    {
        ...
        breed: "shiba inu",
        content:
            " ncludes a Pixel 6 or 6 Pro phone (with an upgrade in two years), an exte… [+1151 chars]",price:" 450"
    },
    {
    ...
    },
    {
        ...
        content:
            " ncludes a Pixel 6 or 6 Pro phone (with an upgrade in two years), an exte… [+1151 chars]",price:" 800"
    },
    {
    ...
    },
    {
        ...
        breed: "siberian husk",
        content:
            " ncludes a Pixel 6 or 6 Pro phone (with an upgrade in two years), an exte… [+1151 chars]",price:" 750"
    },
    {
    ...
    },
    {
        ...
        breed: "poodle",
        content:
            " ncludes a Pixel 6 or 6 Pro phone (with an upgrade in two years), an exte… [+1151 chars]",price:" 900"
    },
    {
            ...
            <tbody>
              {this.state.dogs.map((element) => (
                  <tr>
                   ...
                   <td>{element.description.slice(0,129)}...</td>
                    <td>
                      <Link to={`/admin/editpizza/${this.dogs._id}`}>
...
// import { AiFillEdit, AiFillDelete } from "react-icons/ai";
// import { Table } from "react-bootstrap";
// import { deletePizza, getAllDogs } from "../../actions/dogsAction";
// import Loader from "../../components/Loader";
// import Error from "../../components/Error";
// import { Link } from "react-router-dom";
